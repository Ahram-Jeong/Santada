...
| 권승택 | 오현종 | 윤석인 |
|---|---|---|
|- 소모임 (게시글 목록 (게시판)<br>- 게시글 상세 조회<br>- 게시글 검색, 게시글 작성 / 수정 / 삭제 (소모임장 및 일반 사용자)<br>- 게시글 첨부파일<br>- 댓글 (등록 / 수정 / 삭제)<br>- 소모임 생성<br>- 소모임 리스트<br>- 소모임 정보 상세 조회<br>- 클래스 다이어그램<br>- 프로젝트 SQL DB 취합|- 주차장 정보 조회 기능<br>- DB 자료 조사|- 사용자 인증 (회원가입, 로그인, 로그아웃, 아이디찾기, 비밀번호찾기)<br>- 마이페이지 (회원 정보 수정, 회원 탈퇴 , 포인트 조회, 신고 내역 조회)<br>- 쪽지 (전송, 받은 편지함, 보낸 편지함)<br>- 시퀀스 다이어그램<br>- 시연 영상|
